(function(global, $) {
  ...
  Greetr.prototype = {
    ...
    validate: function() {
      ...
      // references the externally accessible 'supportedLangs' within the closure
    ...
    greet: function(formal) {
      ...
      // by returning 'this', we make function chainable
      return this
    },
    log: function() {
      if(console) {
  ...
  // and provide shorthand $G for ease our poor fingers
